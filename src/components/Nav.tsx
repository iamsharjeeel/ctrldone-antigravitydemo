...
export default function Nav({ onOpenIntake }: NavProps) {
  ...
  return (
    <>
      <header
        ref={navRef}
        className="fixed top-0 left-0 right-0 z-50 h-20 flex items-center justify-between page-x transition-all duration-300 nav-header"
      >
        ...
        <div className="flex items-center gap-8 ml-auto">
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="/login" className="text-[13px] font-mono tracking-[0.08em] uppercase text-text-secondary hover:text-text">
              Login
            </a>
          </nav>
          ...
          <button
            ...
            className="md:hidden p-2.5 rounded-md border border-hairline hover:bg-surface-hover text-text-secondary hover:text-text"
